...
> = {
  ...
  >;
  predict?: Resolver<
    ResolversTypes['Prediction'],
    ParentType,
    ContextType,
    RequireFields<MutationPredictArgs, 'input' | 'modelId'>
  >;
};
...
> = {
  ...
  >;
  getModel?: Resolver<
    Maybe<ResolversTypes['Model']>,
    ParentType,
    ContextType,
    RequireFields<QueryGetModelArgs, 'id'>
  >;
...
> = {
  jobStatusUpdated?: SubscriptionResolver<
    Maybe<ResolversTypes['Job']>,
    'jobStatusUpdated',
    ParentType,
    ContextType,
    RequireFields<SubscriptionJobStatusUpdatedArgs, 'jobId'>
  >;
};
